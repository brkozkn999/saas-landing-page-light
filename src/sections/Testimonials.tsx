...
const TestimonialsColumn = (props: { className?: string, testimonials: typeof testimonials, duration?: number }) => (
  <motion.div animate={{ translateY: "-50%" }} transition={{ repeat: Infinity, duration: props.duration || 10, ease: "linear", repeatType: "loop"}} className={props.className}>
      ...
      <div className="container">
        <div className="section-heading">
          <div className="flex justify-center">
            <div className="tag">Testimonitals</div>
          </div>
